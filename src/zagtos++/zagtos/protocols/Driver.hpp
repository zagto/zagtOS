...
static constexpr UUID DEVICE_CLASS_BLOCK_STORAGE(
...
static constexpr UUID MSG_START_HAL(
            0xd4, 0xa9, 0x72, 0x67, 0x53, 0xff, 0x47, 0x03,
            0x9c, 0x77, 0xaf, 0xef, 0xbe, 0xef, 0xb1, 0x76);
