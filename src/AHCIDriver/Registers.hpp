...
struct ControllerRegisters {
    REGISTER(CAP, BITS(NP,0,5) BIT(SXS,5) BIT(EMS,6) BIT(CCCS,7) BITS(NCS,8,5) BIT(PSC,13)
             BIT(SSC,14) BIT(PMD,15) BIT(FBSS,16) BIT(SPM,17) BIT(SAM,18) BITS(ISS,20,4)
             BIT(SCLO,24) BIT(SAL,25) BIT(SALP,26) BIT(SSS,27) BIT(SMPS,28) BIT(SSNTF,29)
             BIT(SNCQ,30) BIT(S64A,31))
